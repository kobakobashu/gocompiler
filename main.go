...
func semanticAnalyze(fset *token.FileSet, file *ast.File) {
	...
	// Type-check the package containing only file file.
	// Check returns a *types.Package.
	pkg, err := conf.Check("./t", fset, []*ast.File{file}, nil)
	if err != nil {
		panic(err)
	}
